...
<div class="my-16 mb-2 flex sm:w-[80%] mx-auto">
  <div>
    <p class="text-4xl md:text-4xl font-bold md:text-start my-2 text-center" id="section2">Artikel</p>
    ...
    <div class="my-10 text-justify text-base md:text-lg font-sans px-8">
      ...
      <div class="mb-10 text-xl">
        <p>Ditulis oleh <span class="font-semibold">Admin</span> || <span class="font-semibold">{{ \Carbon\Carbon::parse($artikel->created_at)->translatedFormat('l, j F Y') }}</span></p>
      </div>
      <div class="my-10 prose lg:prose-sm max-w-none font-sans">
        {!! str_replace('<a ', '<a style="color: #2563eb;" ', $artikel->body) !!}
      </div>

      <a href="/ug-on-the-press">
