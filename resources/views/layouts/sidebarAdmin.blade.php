...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <a href="/admin/berita" class="flex items-center p-2 text-gray-900 rounded-lg {{($title === 'Data Berita' || $title ===  'Detail Berita' || $title === 'Update Berita') ? 'bg-primary text-white font-bold' : 'bg-white' }}"">
               <svg class="w-6 h-6 {{($title === 'Data Berita' || $title ===  'Detail Berita' || $title === 'Update Berita') ? 'bg-primary text-white font-bold' : 'bg-white' }}e" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
